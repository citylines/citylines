      ...
      <div>
        ...
        >
          <span
            ...
            style={{ display: this.displayMenu() ? 'inline-block' : 'none' }}
          ...
          <Link to="/" tabindex={0} className="c-nav__item c-text--loud">
            <img
              src={assets.path('img/citylines-navbar.svg')}
              className="navbar-logo"
            />
          </Link>
          <div style={{ flexGrow: 2 }} />
          <Link tabindex={0} to="/compare" className="c-nav__item">
            <Translate content="compare.short_title" />
          </Link>
          <Link tabindex={0} to="/data" className="c-nav__item">
            <Translate content="data.short_title" />
          </Link>
          <Link tabindex={0} to="/terms" className="c-nav__item">
          ...
          {this.state.userid ? (
            ...
            <Link tabIndex={0} to="/auth" className="c-nav__item">
              <Translate content="main.log_in" />
            </Link>
          )}
        </nav>
        <div
          id="main-container"
          className={`o-grid o-panel o-panel--nav-top ${
        ...
        <div
          className="u-center-block__content"
          style={{
        ...
        {this.state.showCookieAdvice && (
          <CookieNotice onAccept={this.onAcceptCookie} />
        )}
      </div>
    );
  }
