  ...
  render() {
    return (
        <div className="u-center-block__content">
          ...
          <p> Puede consultar más información sobre cookies en <Link className="c-link" to="http://www.aboutcookies.org">aboutcookies.org</Link>, incluyendo cómo ver las que tiene instaladas y cómo eliminarlas.</p>
        </div>
        )
  }
}
